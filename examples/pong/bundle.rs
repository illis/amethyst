...
use systems::{BounceSystem, MoveBallsSystem, PaddleSystem, WinnerSystem, MassControllerSystem, MassSystem};
...
impl<'a, 'b> SystemBundle<'a, 'b> for PongBundle {
    fn build(self, builder: &mut DispatcherBuilder<'a, 'b>) -> Result<()> {
        builder.add(MassControllerSystem, "mass_controller_system", &[]);
        builder.add(MassSystem, "mass_system", &[]);
